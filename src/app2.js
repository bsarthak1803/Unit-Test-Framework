...
import Unittest from "./1unittest";
import Unittest2 from "./2unittest2";
...
class App extends React.Component {
  ...
  onExecute = event => {
    ...
    // fetch(
    //   "http://vk048320@cmtdev:vk048@localhost:8080/discern/mpages/reports/JSON:group1?parameters=MINE,measure"
    // );
  };
